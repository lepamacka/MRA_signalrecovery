...
from models.helpers import marginal_prob_std, diffusion_coeff
...
from utils import Euler_Maruyama_sampler
...
if __name__ == "__main__":
    ...
    PATH = "./../model_weights/" + model_path_name + "/"
    print(PATH)
    ...
    if length == 3:
        ...
        plt.savefig('./../figs/model_samples_3d.png')
        ax.view_init(elev=90, azim=0, roll=0)
        plt.savefig('./../figs/model_samples_top.png')
    ...
    if length == 3:
        ...
        ax.view_init(elev=35, azim=45, roll=0)
        plt.savefig('./../figs/signal_samples_3d.png')
        ax.view_init(elev=90, azim=0, roll=0)
        plt.savefig('./../figs/signal_samples_top.png')
    ...
    if length == 3:
        ...
        ax.view_init(elev=35, azim=45, roll=0)
        plt.savefig('./../figs/all_samples_3d.png')
        ax.view_init(elev=90, azim=0, roll=0)
        plt.savefig('./../figs/all_samples_top.png')
    ...
    fig.tight_layout()
    plt.savefig('./../figs/projectedscores.png')
    ...
    fig.tight_layout()
    plt.savefig('./../figs/conditionalscores.png')
    ...
    # anim.save('./../figs/diffusion_scores.mp4')
